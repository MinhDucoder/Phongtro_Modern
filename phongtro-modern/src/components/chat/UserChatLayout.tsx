...
export default function UserChatLayout({ activeConversationId }: UserChatLayoutProps) {
  ...
  const handleConversationSelect = (conversationId: string) => {
    ...
    if (conversation) {
      ...
      router.push(`/chat-user/${conversationId}`);
    }
  };
                ...
                {activeConversation && (() => {
                  ...
                  return partner && (
                    <div className="hidden sm:flex items-center">
                      <div className="h-7 w-7 bg-gray-200 rounded-full mr-2 flex items-center justify-center">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          <span className="text-gray-600">{partner.role === 'landlord' ? 'Chủ trọ' : 'Người thuê'}</span>
                        </p>
                      </div>
                    </div>
                  );

...
const footerSections = {
  'Phòng trọ, nhà trọ': [
    { name: 'Phòng trọ Hồ Chí Minh', href: '/?province=TP.HCM&propertyType=phong-tro' },
    { name: 'Phòng trọ Hà Nội', href: '/?province=Hà Nội&propertyType=phong-tro' },
    { name: 'Phòng trọ Đà Nẵng', href: '/?province=Đà Nẵng&propertyType=phong-tro' },
    { name: 'Phòng trọ Cần Thơ', href: '/?province=Cần Thơ&propertyType=phong-tro' },
  ],
  'Thuê nhà nguyên căn': [
    { name: 'Thuê nhà Hồ Chí Minh', href: '/?province=TP.HCM&propertyType=nha-nguyen-can' },
    { name: 'Thuê nhà Hà Nội', href: '/?province=Hà Nội&propertyType=nha-nguyen-can' },
    { name: 'Thuê nhà Bình Dương', href: '/?province=Bình Dương&propertyType=nha-nguyen-can' },
    { name: 'Thuê nhà Đà Nẵng', href: '/?province=Đà Nẵng&propertyType=nha-nguyen-can' },
  ],
  'Cho thuê căn hộ': [
    { name: 'Thuê căn hộ Hồ Chí Minh', href: '/?province=TP.HCM&propertyType=can-ho-chung-cu' },
    { name: 'Thuê căn hộ Hà Nội', href: '/?province=Hà Nội&propertyType=can-ho-chung-cu' },
    { name: 'Thuê căn hộ Bình Dương', href: '/?province=Bình Dương&propertyType=can-ho-chung-cu' },
    { name: 'Thuê căn hộ Đà Nẵng', href: '/?province=Đà Nẵng&propertyType=can-ho-chung-cu' },
  ],
  'Cho thuê mặt bằng': [
    { name: 'Thuê mặt bằng Hồ Chí Minh', href: '/?province=TP.HCM&propertyType=mat-bang' },
    { name: 'Thuê mặt bằng Hà Nội', href: '/?province=Hà Nội&propertyType=mat-bang' },
    { name: 'Thuê mặt bằng Đà Nẵng', href: '/?province=Đà Nẵng&propertyType=mat-bang' },
    { name: 'Thuê mặt bằng Cần Thơ', href: '/?province=Cần Thơ&propertyType=mat-bang' },
  ],
  'Tìm người ở ghép': [
    { name: 'Ở ghép Hồ Chí Minh', href: '/?province=TP.HCM&propertyType=o-ghep' },
    { name: 'Ở ghép Hà Nội', href: '/?province=Hà Nội&propertyType=o-ghep' },
    { name: 'Ở ghép Đà Nẵng', href: '/?province=Đà Nẵng&propertyType=o-ghep' },
    { name: 'Ở ghép Bình Dương', href: '/?province=Bình Dương&propertyType=o-ghep' },
  ],
};

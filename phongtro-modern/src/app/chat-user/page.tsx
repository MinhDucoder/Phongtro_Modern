...
export default async function ChatUserPage({ searchParams }: ChatUserPageProps) {
  return (
    <AuthRequired>
      <ChatUserContent searchParams={searchParams} />
    </AuthRequired>
  );
}

async function ChatUserContent({ searchParams }: ChatUserPageProps) {
